...
window.iconbitmap("C:/Real-Time-Human-Detection-Counting-main/Images/icon.ico")
...
path1 = "C:/Real-Time-Human-Detection-Counting-main/Images/front2.png"
img2 = ImageTk.PhotoImage(Image.open(path1))
panel1 = tk.Label(window, image = img2)
panel1.place(x = 90, y = 250)

# image on the main window
path = "C:/Real-Time-Human-Detection-Counting-main/Images/front1.png"
...
if exit1==False:
    ...
    window1.iconbitmap("C:/Real-Time-Human-Detection-Counting-main/Images/icon.ico")
    ...
    def image_option():
        ...
        windowi.iconbitmap("C:/Real-Time-Human-Detection-Counting-main/Images/icon.ico")
        ...
        def detectByPathImage(path):
            ...
            def img_gen_report():
                ...
                pdf.image("C:/Real-Time-Human-Detection-Counting-main/Images/Crowd_Report.png", x=0, y=0, w=210, h=297)
                ...
                pdf.output("C:/Real-Time-Human-Detection-Counting-main/Images/Crowd_Report.docx")
    ...
    def video_option():
        ...
        windowv.iconbitmap("C:/Real-Time-Human-Detection-Counting-main/Images/icon.ico")
        ...
        def detectByPathVideo(path, writer):
            ...
            def vid_gen_report():
                ...
                pdf.output("C:/Real-Time-Human-Detection-Counting-main/Crowd_Report.pdf")
    ...
    def camera_option():
        ...
        windowc.iconbitmap("C:/Real-Time-Human-Detection-Counting-main/Images/icon.ico")
